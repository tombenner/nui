...
- (void)programmaticallyRenderControls
{
    ...
    [largeButton setFrame:CGRectMake(20, 75, 133, 50)];
    [self.view addSubview:largeButton];
    
    UIButton *button = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [button setTitle:@"Button" forState:UIControlStateNormal];
    [button setFrame:CGRectMake(20, 144, 74, 37)];
    ...
    [smallButton setFrame:CGRectMake(20, 200, 57, 24)];
    [self.view addSubview:smallButton];
    
    UILabel *largeLabel = [[UILabel alloc] initWithFrame:CGRectMake(167, 75, 133, 40)];
    [largeLabel setText:@"Large Label"];
    [largeLabel setNuiClass:@"Label:LargeLabel"];
    [self.view addSubview:largeLabel];
    
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(110, 147, 62, 32)];
    [label setText:@"Label"];
    [self.view addSubview:label];
    
    UILabel *smallLabel = [[UILabel alloc] initWithFrame:CGRectMake(92, 201, 52, 21)];
    [smallLabel setText:@"Small"];
    [smallLabel setNuiClass:@"Label:SmallLabel"];
    [self.view addSubview:smallLabel];
    
    UITextField *largeTextField = [[UITextField alloc] initWithFrame:CGRectMake(20, 244, 159, 31)];
    ...
    UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(20, 312, 93, 31)];
    ...
    [segmentedControl setFrame:CGRectMake(20, 373, 190, 30)];
    [segmentedControl setSelectedSegmentIndex:0];
    [self.view addSubview:segmentedControl];
    
    UISwitch *uiSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(223, 374, 79, 27)];
    [uiSwitch setOn:YES];

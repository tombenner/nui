...
#define COCOAPODS_POD_AVAILABLE_UIImage_ColorFromImage
#define COCOAPODS_VERSION_MAJOR_UIImage_ColorFromImage 0
#define COCOAPODS_VERSION_MINOR_UIImage_ColorFromImage 0
#define COCOAPODS_VERSION_PATCH_UIImage_ColorFromImage 2

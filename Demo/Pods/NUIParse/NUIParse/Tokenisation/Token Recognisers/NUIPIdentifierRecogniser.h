...
/**
 * The NUIPIdentifierRecogniser class attempts to recognise identifiers on the input string.
 *
 ...
 * 
 * This recogniser produces NUIPIdentifierTokens.
 */
 ...
 *
 * @return Returns a NUIPIdentifierRecogniser that recognises C like identifiers.
 *
 ...
 * @return Returns a NUIPIdentifierRecogniser that recognises identifiers based on the input character sets.
 *
 ...
 * @param initialCharacters The set of characters that the identifier may begin with.
 * @param identifierCharacters The set of characters that the identifier may contain, after its first character.
 * @return Returns the NUIPIdentifierRecogniser that recognises identifiers based on the input character sets.
 *
 * @see identifierRecogniserWithInitialCharacters:identifierCharacters:
 */

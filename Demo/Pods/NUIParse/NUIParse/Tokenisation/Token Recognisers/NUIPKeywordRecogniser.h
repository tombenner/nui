...
/**
 * The NUIPKeywordRecogniser class attempts to recognise a specific keyword in a token stream.
 * 
 ...
 * 
 * This recogniser produces NUIPKeywordTokens.
 */

...
/**
 * The NUIPTokenRecogniser protocol defines methods needed to recognise tokens in a string.
 */
@protocol NUIPTokenRecogniser <NSObject, NSCoding>

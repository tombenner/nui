...
#define NUIPEBNFParserErrorDomain @"NUIPEBNFParserErrorDomain"

typedef enum
{
    NUIPErrorCodeCouldNotParseEBNF    = 1,
    NUIPErrorCodeDuplicateTag         = 2,
    NUIPErrorCodeUndefinedNonTerminal = 3,
} NUIPErrorCode;

/**
 * The NUIPGrammar class represents a context free grammar.  Grammars can be used later to construct parsers.
 */
 ...
 * @param rules An array of NUIPRules to describe the grammar.
 * @return Returns a NUIPGrammar based on the rules and starting non-terminal.
 *
 ...
 * @return Returns a NUIPGrammar based on the BNF and starting non-terminal.
 *

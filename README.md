...
* **BorderStyle** - A border style, as rendered by a UITextBorderStyle.
Accepted values are `none`, `line`, `bezel`, and `rounded`. Note: single
borders can be drawn using border style `none` and specifying `border`.
